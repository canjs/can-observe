...
/*can-observation-recorder@0.1.2#can-observation-recorder*/
...
/*can-observe@2.0.0-pre.15#src/-observable-store*/
...
/*can-observe@2.0.0-pre.15#src/-helpers*/
...
/*can-observe@2.0.0-pre.15#src/-make-object*/
    ...
    var makeObject = {
        ...
        deleteProperty: function (target, key) {
            ...
            if (ret && this.preventSideEffects === 0 && old !== undefined) {
                ...
                queues.enqueueByQueue(this.handlers.getNode([symbols.keysSymbol]), this.proxy, [
                    undefined,
                    key
                ]);
                var patches = [{
...
/*can-util@3.10.17#js/diff-array/diff-array*/
...
/*can-observe@2.0.0-pre.15#src/-make-array*/
...
/*can-observe@2.0.0-pre.15#src/-make-function*/
...
/*can-observe@2.0.0-pre.15#src/-make-observe*/
...
/*can-event-queue@0.12.1#map/map*/
...
/*can-event-queue@0.12.1#type/type*/
...
/*can-observation@4.0.0-pre.22#recorder-dependency-helpers*/
...
/*can-event-queue@0.12.1#value/merge-dependency-records*/
...
/*can-event-queue@0.12.1#value/value*/
...
/*can-observation@4.0.0-pre.22#can-observation*/
...
/*can-observe@2.0.0-pre.15#src/-getter-helpers*/
...
/*can-observe@2.0.0-pre.15#object/object*/
...
/*can-observe@2.0.0-pre.15#array/array*/
...
/*can-observe@2.0.0-pre.15#can-observe*/
define('can-observe', [
    'require',
    'exports',
    'module',
